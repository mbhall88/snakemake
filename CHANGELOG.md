...
## [8.0.0](https://github.com/mbhall88/snakemake/compare/v7.32.2...v8.0.0) (2023-12-06)


### ⚠ BREAKING CHANGES

* redesigned Snakemake API. It now uses a modern, dataclass based approach ([#2403](https://github.com/mbhall88/snakemake/issues/2403))

### Features

* ability to encode paramspaces into a single wildcard, via the newly introduced `single_wildcard` argument of `Paramspace`. ([#2069](https://github.com/mbhall88/snakemake/issues/2069)) ([728ab3c](https://github.com/mbhall88/snakemake/commit/728ab3cf59fb188bf1872a5cab3aba4519340a06))
* add  keyword to gridftp remote provide to specify the number or disable usage of multiple data stream ([#1974](https://github.com/mbhall88/snakemake/issues/1974)) ([3e6675d](https://github.com/mbhall88/snakemake/commit/3e6675df26bf65fa27006ea57a4c3cf36b89d6da))
* add ability to inject conda environments into running Snakefile ([#2479](https://github.com/mbhall88/snakemake/issues/2479)) ([6140e29](https://github.com/mbhall88/snakemake/commit/6140e29864cf0fcdd83194f218408867c54b730d))
* add Bash script functionality ([#1821](https://github.com/mbhall88/snakemake/issues/1821)) ([c4cf8fd](https://github.com/mbhall88/snakemake/commit/c4cf8fdb119e678e51fd1932392699957c63b6c4))
* add cleanup containers option ([#2088](https://github.com/mbhall88/snakemake/issues/2088)) ([053e3b3](https://github.com/mbhall88/snakemake/commit/053e3b37cfcc6c67bae6ac3660b82879b75acb4c))
* add flag `ensure` that allows to annotate that certain output files should be non-empty or agree with a given checksum ([#1651](https://github.com/mbhall88/snakemake/issues/1651)) ([76f69d9](https://github.com/mbhall88/snakemake/commit/76f69d9e21b9c9a9a01198862b66284bc3942d20))
* add functionality for deploying sources if no shared FS is assumed ([#2486](https://github.com/mbhall88/snakemake/issues/2486)) ([76eac3c](https://github.com/mbhall88/snakemake/commit/76eac3c570624f818ff43f4759a27a3e284bf03c))
* add gitfile option to make it possible to use local git repos when importing modules ([#1376](https://github.com/mbhall88/snakemake/issues/1376)) ([1a3b91f](https://github.com/mbhall88/snakemake/commit/1a3b91fa8461d44bc1583f1d2e33ff2bae1360b3))
* add option to control software deployment mode (shared or non shared FS) ([#2525](https://github.com/mbhall88/snakemake/issues/2525)) ([04ec2c0](https://github.com/mbhall88/snakemake/commit/04ec2c0262b2cb96cbcd7edbbb2596979c1703ae))
* add pyproject.toml to use setuptools features ([#1725](https://github.com/mbhall88/snakemake/issues/1725)) ([454bfd1](https://github.com/mbhall88/snakemake/commit/454bfd17aba8631ea34d6a8971b1db60b2955965))
* Add support for Google Service Accounts and GCE VM network configuration ([#2318](https://github.com/mbhall88/snakemake/issues/2318)) ([2b754aa](https://github.com/mbhall88/snakemake/commit/2b754aae535ef76bd2dd34bc31d5c9f5c69363de))
* add support for Kubernetes service account name spec ([#2254](https://github.com/mbhall88/snakemake/issues/2254)) ([3370426](https://github.com/mbhall88/snakemake/commit/3370426da7ee78af5de54689f623e2b5afa45f1f))
* Add support for tokens in the XRootD interface ([#2076](https://github.com/mbhall88/snakemake/issues/2076)) ([bca013a](https://github.com/mbhall88/snakemake/commit/bca013acdb4508e388b621cd970f65082f88150f))
* add tes token ([#1966](https://github.com/mbhall88/snakemake/issues/1966)) ([59a8fa0](https://github.com/mbhall88/snakemake/commit/59a8fa04c4c6b113775fe11228b82510ecd36cb8))
* Add token auth to GitLab/GitHub hosting providers ([#1761](https://github.com/mbhall88/snakemake/issues/1761)) ([e03a3b4](https://github.com/mbhall88/snakemake/commit/e03a3b42eea89d512290bf98ee7d77ce2e17447c)), closes [#1301](https://github.com/mbhall88/snakemake/issues/1301)
* added localrule directive ([#2180](https://github.com/mbhall88/snakemake/issues/2180)) ([9c990b0](https://github.com/mbhall88/snakemake/commit/9c990b076b51e9e2123ced56bfab176e03424770))
* adding flux executor ([#1810](https://github.com/mbhall88/snakemake/issues/1810)) ([40d2bd0](https://github.com/mbhall88/snakemake/commit/40d2bd071984914ac511e7858690dfd16cefaf69))
* allow config files to be processed with YTE ([#2269](https://github.com/mbhall88/snakemake/issues/2269)) ([8e1c22f](https://github.com/mbhall88/snakemake/commit/8e1c22ff54e85ee941c6e0ac74dd594fce80efbb))
* allow detailed configuration of shared FS usage ([#2528](https://github.com/mbhall88/snakemake/issues/2528)) ([0d34be9](https://github.com/mbhall88/snakemake/commit/0d34be90040f937021eb25becb4ef5d5aae66473))
* allow environment variables in string values of profile (e.g. paths may now contain elements like $USER). ([58dc70c](https://github.com/mbhall88/snakemake/commit/58dc70c513d08cb217647ec591df93b40517b650))
* allow for human friendly resource definitions (e.g. mem="5GB", runtime="1d") ([#1861](https://github.com/mbhall88/snakemake/issues/1861)) ([24610ac](https://github.com/mbhall88/snakemake/commit/24610ac75849d543fc38c83fb2454fa4f9b42075))
* allow input, output, and params to be used in functions passed to report mark arguments ([#2081](https://github.com/mbhall88/snakemake/issues/2081)) ([93ff8b6](https://github.com/mbhall88/snakemake/commit/93ff8b604a152f50ca31389ecffe1a7527c5b5a8))
* Allow paramspace to separate filename params with custom separator ([#1299](https://github.com/mbhall88/snakemake/issues/1299)) ([8236e80](https://github.com/mbhall88/snakemake/commit/8236e80794d0f9c9670238ba168770c0947e8379))
* allow profiles to be YTE templates; adapt to eido 2.0 ([#2325](https://github.com/mbhall88/snakemake/issues/2325)) ([67d9ff2](https://github.com/mbhall88/snakemake/commit/67d9ff20ea61186d3818e7bc1d33e4414058fc1f))
* allow python expressions in --set-resources ([#2521](https://github.com/mbhall88/snakemake/issues/2521)) ([022a31e](https://github.com/mbhall88/snakemake/commit/022a31e0e75416904589c62b58e54c952d930c69))
* Allow the environment variable SNAKEMAKE_CONDA_PREFIX to be present without --use-conda ([#2263](https://github.com/mbhall88/snakemake/issues/2263)) ([e4eba8d](https://github.com/mbhall88/snakemake/commit/e4eba8d72b84aaa460c7d1b1ac54b607e844d782))
* allow to define the cache mode per rule (this enables to exclude software envs from the caching hash value, which can be handy e.g. for download rules where the software version does not affect the result) ([#1933](https://github.com/mbhall88/snakemake/issues/1933)) ([715e618](https://github.com/mbhall88/snakemake/commit/715e6187e9a132c2a61f5bef34a1e10491680b0a))
* allow to set latency_wait in executor test suite ([c0bca0b](https://github.com/mbhall88/snakemake/commit/c0bca0bb8bf66fb34def7459f757140ce3825a25))
* automatically rerun jobs if parameters, code, input file set, or software stack changed (thanks to [@cclienty](https://github.com/cclienty) and [@timtroendle](https://github.com/timtroendle)). This also increases performance of DAG building by handling job "needrun" updates level wise, while avoiding to perform a full check for those jobs that are already downstream of a job that has been determined to require a rerun. ([#1663](https://github.com/mbhall88/snakemake/issues/1663)) ([4c11893](https://github.com/mbhall88/snakemake/commit/4c11893d2fda5824adff44d16d7741484e63efea))
* automatically upload workflow sources to default storage provider if no shared FS is used ([a450c49](https://github.com/mbhall88/snakemake/commit/a450c4998de3ab7deb0fb2bc19dc59fdc484309d))
* Azbatch executor ([#1953](https://github.com/mbhall88/snakemake/issues/1953)) ([#2246](https://github.com/mbhall88/snakemake/issues/2246)) ([0f9c49f](https://github.com/mbhall88/snakemake/commit/0f9c49fe8643cca0e42e3b091cf9706a7feb877d))
* changed report layout to display menu always left of the results. For fullscreen, one can still hide the menu, which leads to automatic growth of the results ([#2116](https://github.com/mbhall88/snakemake/issues/2116)) ([d771b1b](https://github.com/mbhall88/snakemake/commit/d771b1b5fc8344aaffe1f30388d4e4d31d4fe937))
* enable restricted access support in zenodo remote provider ([#1623](https://github.com/mbhall88/snakemake/issues/1623)) ([692caf9](https://github.com/mbhall88/snakemake/commit/692caf963d90313d2cd8117fecde097b228633ce))
* enable the definition of conda pin files in order to freeze an environment. This can drastically increase the robustness because it allows to freeze an environment at a working state. ([#1667](https://github.com/mbhall88/snakemake/issues/1667)) ([53972bf](https://github.com/mbhall88/snakemake/commit/53972bfddcca836d5abb8cdd452cbea40ab2571f))
* Faster ci test setup  ([#2489](https://github.com/mbhall88/snakemake/issues/2489)) ([4798e8a](https://github.com/mbhall88/snakemake/commit/4798e8ac226bded585e9fe31d43ae9e93a598780))
* first try to match output files against input files while persisting wildcard values from the consuming job. This can dramatically reduce ambiuity problems. Thanks to [@descostesn](https://github.com/descostesn)! ([#1939](https://github.com/mbhall88/snakemake/issues/1939)) ([d093907](https://github.com/mbhall88/snakemake/commit/d093907417778c7693a05ed1f38fc40b8d34d9ba))
* for small files, compare checksums to determine if job needs to run if input file is newer than output file ([#1568](https://github.com/mbhall88/snakemake/issues/1568)) ([1ae85c6](https://github.com/mbhall88/snakemake/commit/1ae85c6b57b3c6b5860214a9c0e3ab28c7c8c5dc))
* Group resources ([#1218](https://github.com/mbhall88/snakemake/issues/1218)) ([a8014d0](https://github.com/mbhall88/snakemake/commit/a8014d030a2a3ea04743e30bcf5164801291378f))
* implement precommand ([#2482](https://github.com/mbhall88/snakemake/issues/2482)) ([ff0f979](https://github.com/mbhall88/snakemake/commit/ff0f979b68b1e12be8151c7f5547c6a13ad3ee9a))
* introduce --workflow-profile for additional workflow specific profiles that overwrite global profiles; add ability to define key-value CLI flags like --set-threads or --set-resources as multi-level dictionaries in profile config yaml files ([#2310](https://github.com/mbhall88/snakemake/issues/2310)) ([9675c17](https://github.com/mbhall88/snakemake/commit/9675c17d4d7cbb95e589767974faa9219dd4154d))
* k8s: add --k8s-cpu-scalar ([#1857](https://github.com/mbhall88/snakemake/issues/1857)) ([a067a1b](https://github.com/mbhall88/snakemake/commit/a067a1b6eb8f6432348bc257782faba40f89e805))
* limit the number of input/output files in job properties ([#2149](https://github.com/mbhall88/snakemake/issues/2149)) ([d93f091](https://github.com/mbhall88/snakemake/commit/d93f091acea63a662dcb350c3f86c15fa9bdf721))
* LockException ([#1276](https://github.com/mbhall88/snakemake/issues/1276)) ([f5e6fa6](https://github.com/mbhall88/snakemake/commit/f5e6fa68a68640ed39df86c256d676f2e4efddfc))
* make it possible to exclude rules that will be imported when using 'use rule' statement ([#1717](https://github.com/mbhall88/snakemake/issues/1717)) ([d9e0611](https://github.com/mbhall88/snakemake/commit/d9e061178bd22307cc710bea28a5994e866260d9))
* new directive "retries" for annotating the number of times a job shall be restarted after a failure ([#1649](https://github.com/mbhall88/snakemake/issues/1649)) ([c8d81d0](https://github.com/mbhall88/snakemake/commit/c8d81d03de2885d5d0473084141e9f6abc5de445))
* prepare for storage plugins ([#2454](https://github.com/mbhall88/snakemake/issues/2454)) ([353a71c](https://github.com/mbhall88/snakemake/commit/353a71cba1d3dfcc48136b2d6cb744cc1252623b))
* print reason summary in case of dryrun ([#1778](https://github.com/mbhall88/snakemake/issues/1778)) ([bd2a68b](https://github.com/mbhall88/snakemake/commit/bd2a68bb8a7ddb64ad91bb822aa7d0342e884704))
* provide information about temp, pipe, and service files in --summary ([#1977](https://github.com/mbhall88/snakemake/issues/1977)) ([c7c7776](https://github.com/mbhall88/snakemake/commit/c7c7776f8722adf94e6a176174cb0a7564f11d9f))
* Publish docker images for amd64 & arm64 ([#2105](https://github.com/mbhall88/snakemake/issues/2105)) ([4c898f5](https://github.com/mbhall88/snakemake/commit/4c898f5587d832c45f0b534681f9502abe1de6ce))
* redesigned Snakemake API. It now uses a modern, dataclass based approach ([#2403](https://github.com/mbhall88/snakemake/issues/2403)) ([2be3bfa](https://github.com/mbhall88/snakemake/commit/2be3bfa4841967928069a2a024554b8a86b699f1))
* SLURM executor ([#1015](https://github.com/mbhall88/snakemake/issues/1015)) ([c7ea059](https://github.com/mbhall88/snakemake/commit/c7ea0590c396c67fa5d56042e21f678c20784d3b))
* Support conda environment definitions to be passed as function pointers, similar to input, params, and resources ([#1300](https://github.com/mbhall88/snakemake/issues/1300)) ([6f582f1](https://github.com/mbhall88/snakemake/commit/6f582f180f5df9292e005623f093a3a0b2e597a7))
* support for external executor plugins ([#2305](https://github.com/mbhall88/snakemake/issues/2305)) ([c9eaa4e](https://github.com/mbhall88/snakemake/commit/c9eaa4e12e4a348f93e5ea5793faaec1fd547fac))
* Tes auth ([#2169](https://github.com/mbhall88/snakemake/issues/2169)) ([3326a6f](https://github.com/mbhall88/snakemake/commit/3326a6f7bbaf9c277400625649c3da903e251e2f))
* version specific profile config files (profile/config.v8+.yaml with profile/config.yaml as fallback that matches any version) ([#2498](https://github.com/mbhall88/snakemake/issues/2498)) ([47e5811](https://github.com/mbhall88/snakemake/commit/47e581181f952884577f0237a1aa9457ee9554dd))
* vim syntax updates ([#1584](https://github.com/mbhall88/snakemake/issues/1584)) ([b8c77f6](https://github.com/mbhall88/snakemake/commit/b8c77f6a2a1372a5c3ad8077ad36facf393bfacf))


### Bug Fixes

* :bug: - fix hyperlink ([#2046](https://github.com/mbhall88/snakemake/issues/2046)) ([9519d31](https://github.com/mbhall88/snakemake/commit/9519d31b4ed2390d5c14f0f6a754ca665374d15c))
* [#2130](https://github.com/mbhall88/snakemake/issues/2130) by patching the protect() method so the path of files in subdirectories is properly resolved during write-protection ([#2131](https://github.com/mbhall88/snakemake/issues/2131)) ([1a754fd](https://github.com/mbhall88/snakemake/commit/1a754fd094bd13bb4a201f1c80a077656c89f995))
* `sre_constants` import because of deprecation ([#2139](https://github.com/mbhall88/snakemake/issues/2139)) ([3b326db](https://github.com/mbhall88/snakemake/commit/3b326dba22ef5358092c281479eafafe3480eeae))
* 2142 log directive in default target rule ([#2191](https://github.com/mbhall88/snakemake/issues/2191)) ([86e9624](https://github.com/mbhall88/snakemake/commit/86e962488dcd346cd0a29a2ff1b2dcd1abafb841))
* adapt linting rule to Python 3.11 ([a3a5c58](https://github.com/mbhall88/snakemake/commit/a3a5c58cbbbe9a84b7383ce046b5981271288979))
* adapt to changes in snakemake-interface-executor-plugins ([635c68a](https://github.com/mbhall88/snakemake/commit/635c68abe3c6e01a70803f2423718a99ea056a00))
* Add back logging of run directives ([#1883](https://github.com/mbhall88/snakemake/issues/1883)) ([a65559c](https://github.com/mbhall88/snakemake/commit/a65559c1e21d65e5b4509b9565b472e734ab9f02))
* add lock free mechanism for avoiding race conditions when writing persistence information; consider corrupt metadata records as non-existent ([#1745](https://github.com/mbhall88/snakemake/issues/1745)) ([71fe952](https://github.com/mbhall88/snakemake/commit/71fe9527bb7011ba01d25fdd21c102c135412c04))
* add missing spaces between lines that get concatenated. ([#2268](https://github.com/mbhall88/snakemake/issues/2268)) ([7238458](https://github.com/mbhall88/snakemake/commit/7238458c6d56c5d94787b93668718358ad44e9ef))
* add storage provider args to deploy sources command ([67178e3](https://github.com/mbhall88/snakemake/commit/67178e31e68dc165c503d49eaf40340a9ad65e90))
* addressing [#2197](https://github.com/mbhall88/snakemake/issues/2197) by allowing 256 character account names in slurm ([#2198](https://github.com/mbhall88/snakemake/issues/2198)) ([ab58c65](https://github.com/mbhall88/snakemake/commit/ab58c652847c03a9f1529d2d7632f2788a5fadc4))
* allocation of local ssds in k8s tests ([#1870](https://github.com/mbhall88/snakemake/issues/1870)) ([d0de4dc](https://github.com/mbhall88/snakemake/commit/d0de4dccf6f6c749da0d4a30ef27fe0f9274995d))
* allow apptainer as a successor to singularity. ([#1706](https://github.com/mbhall88/snakemake/issues/1706)) ([bcbdb0b](https://github.com/mbhall88/snakemake/commit/bcbdb0bc44746961838f9603e42d0e171407c740))
* allow labels function to return None ([#1565](https://github.com/mbhall88/snakemake/issues/1565)) ([fef74d6](https://github.com/mbhall88/snakemake/commit/fef74d6406a04e29c115a699e76ac96e4a37cf9e))
* allow report generation to handle pathlib objects ([#1904](https://github.com/mbhall88/snakemake/issues/1904)) ([7c34656](https://github.com/mbhall88/snakemake/commit/7c346569106a36bbbce990576324af472ada9efd))
* allow script directive to take pathlib Path ([#1869](https://github.com/mbhall88/snakemake/issues/1869)) ([12cdc96](https://github.com/mbhall88/snakemake/commit/12cdc961c86541d5c50533a6b8ff5df0cb6fd7d1))
* allow to use {wildcards} for group jobs in cluster config ([#1555](https://github.com/mbhall88/snakemake/issues/1555)) ([f0ec73d](https://github.com/mbhall88/snakemake/commit/f0ec73d2470d3ecf1d8500b52fa86021463a96fe))
* also inherit rule proxies if there is no rulename modifier specified in a use rule statement ([#2440](https://github.com/mbhall88/snakemake/issues/2440)) ([1570289](https://github.com/mbhall88/snakemake/commit/15702891b31635a79f31e857d09f3e285f71717b))
* always make sure that the original path of source cached files is properly passed into metadata persistence records ([#2179](https://github.com/mbhall88/snakemake/issues/2179)) ([8bacbd0](https://github.com/mbhall88/snakemake/commit/8bacbd0b19b0e372f5840b1fab838b79a6bab557))
* always recalculate job resources before job is scheduled as input might have changed or not have been present initially ([#1552](https://github.com/mbhall88/snakemake/issues/1552)) ([44aacdb](https://github.com/mbhall88/snakemake/commit/44aacdbb35879e1d7914aa105401541465387955))
* assume at most 8GB memory for default resources. This way, we avoid exploding memory requirements for large input files that are very unlikely to be put entirely into memory by any tool. ([11c2ecc](https://github.com/mbhall88/snakemake/commit/11c2eccfa72a2732d20a66bbf57995ee9dfd14ae))
* assume shared filesystem by default when running with --flux ([#2075](https://github.com/mbhall88/snakemake/issues/2075)) ([4bec2fd](https://github.com/mbhall88/snakemake/commit/4bec2fd3bb0c48a1f38506a966cb64dc8c2d1021))
* avoid "Admin" prompt when using conda on windows ([#1046](https://github.com/mbhall88/snakemake/issues/1046)) ([552fadf](https://github.com/mbhall88/snakemake/commit/552fadf7d0ea0f0ff3990295db2618a31c692f61))
* avoid erroneous too early deletion of parent directories in case of failed jobs (thanks to @SichongP). ([#1601](https://github.com/mbhall88/snakemake/issues/1601)) ([b0917e6](https://github.com/mbhall88/snakemake/commit/b0917e6f07e356764880632495ec3567ec8555b4))
* avoid logfile writing in case of dryrun; better hints in case of incomplete checkpoints ([#1994](https://github.com/mbhall88/snakemake/issues/1994)) ([a022705](https://github.com/mbhall88/snakemake/commit/a022705db14c9409b1ceadf6d5ae6367833e2131))
* batch collect jobs for scancel ([#2114](https://github.com/mbhall88/snakemake/issues/2114)) ([0b1fe31](https://github.com/mbhall88/snakemake/commit/0b1fe312e8c98a814b1c419940f35253f58f958e))
* better job status queries for slurm executor  ([#2136](https://github.com/mbhall88/snakemake/issues/2136)) ([a4df38c](https://github.com/mbhall88/snakemake/commit/a4df38c56e935dde9c2745bed6afc13e1fed671f))
* better message about profile usage upon execution ([#2391](https://github.com/mbhall88/snakemake/issues/2391)) ([cf8aea5](https://github.com/mbhall88/snakemake/commit/cf8aea5862767f104c7e03c09369d401f25d50e7))
* Bump yte from &gt;=1.0,&lt;2.0 to >=1.5.1,<2.0 ([#2275](https://github.com/mbhall88/snakemake/issues/2275)) ([8c0b34f](https://github.com/mbhall88/snakemake/commit/8c0b34f869e4f65ff2e47cf5f1e2863bd104f8e7))
* catch errors in remote.AUTO provider list ([#1834](https://github.com/mbhall88/snakemake/issues/1834)) ([c613ed2](https://github.com/mbhall88/snakemake/commit/c613ed217f1dfb16fc63fa7b06af4ddf4f3dd0b8))
* Catch missing error stream in Slurm executor ([#2063](https://github.com/mbhall88/snakemake/issues/2063)) ([c21fc7e](https://github.com/mbhall88/snakemake/commit/c21fc7e528327b13d762c5db90ee0e40506cf0bd))
* Change ratelimiter dependency to throttler ([#1958](https://github.com/mbhall88/snakemake/issues/1958)) ([50b8f16](https://github.com/mbhall88/snakemake/commit/50b8f1609a597dc9f25d2fd86c9cdda531bdc041))
* change source cache entries to keep the original name and folder structure, such that imports from e.g. scripts also work with remote modules (if specified as additional input files with workflow.source_path) ([#1936](https://github.com/mbhall88/snakemake/issues/1936)) ([c34f3f6](https://github.com/mbhall88/snakemake/commit/c34f3f64ac19d2c2eaab361d73d3144430538bb6))
* check for skipped rules in case of local rule inheritance ([#1631](https://github.com/mbhall88/snakemake/issues/1631)) ([9083ac1](https://github.com/mbhall88/snakemake/commit/9083ac1f40daf3d284ce9b1ac2d4addde9b5b258))
* Comparison of rules and non-rule instances ([#1894](https://github.com/mbhall88/snakemake/issues/1894)) ([bf01ece](https://github.com/mbhall88/snakemake/commit/bf01ece0e9c51442daba02ecf2ef37aa276283d6))
* comparison to float in scheduler ([ef44d84](https://github.com/mbhall88/snakemake/commit/ef44d844b81d671604a1ce285a43ca1d5ea59d96))
* conda create --no-shortcuts absent on Linux/MacOS (regression from [#1046](https://github.com/mbhall88/snakemake/issues/1046)) ([#1916](https://github.com/mbhall88/snakemake/issues/1916)) ([8a86a1e](https://github.com/mbhall88/snakemake/commit/8a86a1e5ec7438492e2f1403b1b0fd81030255ad))
* conda env inside script ([#1812](https://github.com/mbhall88/snakemake/issues/1812)) ([49cac6a](https://github.com/mbhall88/snakemake/commit/49cac6ac67fba360f2f35be7ab1972b2d8cc1f8b))
* conda python interpreter path on Windows ([#1711](https://github.com/mbhall88/snakemake/issues/1711)) ([155c9d6](https://github.com/mbhall88/snakemake/commit/155c9d6688a99db4b49c5b25d5a8a65a3aca532d))
* Consider source cache when setting search path for python scripts. This allows to import from Python modules next to scripts while deploying the workflow as a snakemake module, even from remote locations. ([#1940](https://github.com/mbhall88/snakemake/issues/1940)) ([27be1d4](https://github.com/mbhall88/snakemake/commit/27be1d41c397a974f33dcf93ccce331a80ab0198))
* consistently use text output in conda shell commands and various little fixes for failing test cases due to conda package changes ([#1864](https://github.com/mbhall88/snakemake/issues/1864)) ([4234fe7](https://github.com/mbhall88/snakemake/commit/4234fe765e996dbb3a1738567299ebb4d8c28af0))
* correctly parse empty values in config cli ([#2032](https://github.com/mbhall88/snakemake/issues/2032)) ([1b0689d](https://github.com/mbhall88/snakemake/commit/1b0689dddf5eecbd8afd307c6df3dc31a32c338f))
* Correctly parse UserDicts in executors ([#2016](https://github.com/mbhall88/snakemake/issues/2016)) ([e3926fa](https://github.com/mbhall88/snakemake/commit/e3926fa4b44bedf99745b949080397919a522aa1))
* declare associative arrays ([#1844](https://github.com/mbhall88/snakemake/issues/1844)) ([90ae449](https://github.com/mbhall88/snakemake/commit/90ae44943a6b7712d46677364752bf0a7cf91806))
* delay evaluation of tmpdir to actual job execution, and not submission. This way, tmpdir can be dependent on the node context. ([#1860](https://github.com/mbhall88/snakemake/issues/1860)) ([4203556](https://github.com/mbhall88/snakemake/commit/420355662ebea0bc72c9bd6bca1eea5259f3b43e))
* detect job paths that leave and then enter a group. Such paths are invalid because then the group depends on itself. ([#2527](https://github.com/mbhall88/snakemake/issues/2527)) ([5383a4d](https://github.com/mbhall88/snakemake/commit/5383a4d85f8b7a3fb61fd0b457fcd1d008c2255f))
* Detect pandas availability to select serializer ([#2300](https://github.com/mbhall88/snakemake/issues/2300)) ([e08a771](https://github.com/mbhall88/snakemake/commit/e08a771f90aef84f3075e07c8d4e4c0f7881047c))
* do not allow setting benchmark and between-workflow caching for the same rule. The reason is that when the result is taken from cache, there is no way to fill the benchmark file with any reasonable values. ([#2335](https://github.com/mbhall88/snakemake/issues/2335)) ([e2d64fa](https://github.com/mbhall88/snakemake/commit/e2d64fad76b8ca1805eeaa48c0bf8d1fb7bf4736))
* do not overwrite default resources setting in azure batch executor ([#2395](https://github.com/mbhall88/snakemake/issues/2395)) ([4aef3b9](https://github.com/mbhall88/snakemake/commit/4aef3b93ddf029c532fabe38e05c262dd4237b5f))
* do not remove existing temp files in case of dryrun ([#1543](https://github.com/mbhall88/snakemake/issues/1543)) ([e820f97](https://github.com/mbhall88/snakemake/commit/e820f973ad8ca99822be69c927c7d7bf6a89f54e))
* do not wrap whitespace in result info headers of reports ([653d0d0](https://github.com/mbhall88/snakemake/commit/653d0d0b92d2556e0fa04a8208f37fd982dcb829))
* Enable values with an = sign in default_resources ([#2340](https://github.com/mbhall88/snakemake/issues/2340)) ([c1c9229](https://github.com/mbhall88/snakemake/commit/c1c922904f09c133e39872346a541e7cd216d0d2))
* ensure lazy evaluation of resource functions/callables (this also entails, for now, a removal of the thread statistics in the yellow job stats table); further, added some clarifying sentences about resource function evaluation to the docs ([#2356](https://github.com/mbhall88/snakemake/issues/2356)) ([4c591b7](https://github.com/mbhall88/snakemake/commit/4c591b72b31d6c6c36b43f1d7773d8317352fbc9))
* ensure that auto deployment of default storage provider works in containers with read-only root home. ([1a347ff](https://github.com/mbhall88/snakemake/commit/1a347ffd8b2144aee5c35ea17fec2262c5cc9c40))
* ensure that rule inheritance considers the same globals and other settings as parent module ([#1621](https://github.com/mbhall88/snakemake/issues/1621)) ([104cab9](https://github.com/mbhall88/snakemake/commit/104cab97d9e1a7dda4c9948efa5883d5478d2229))
* ensure that rule name string instead of object is passed to tabulate package ([#1898](https://github.com/mbhall88/snakemake/issues/1898)) ([f9ff157](https://github.com/mbhall88/snakemake/commit/f9ff157c5c534ba035bdf51a02fbbba5ad94dd61))
* ensure that targetjob is always forced. This fixes a bug causing run-directive rules to not being executed even when enforced via e.g. -R. ([#2448](https://github.com/mbhall88/snakemake/issues/2448)) ([b2a60d5](https://github.com/mbhall88/snakemake/commit/b2a60d5674c84f58c6e48af5d675ce4690a1d625))
* ensure user and group rw permissions for metadata files and source cache ([#2132](https://github.com/mbhall88/snakemake/issues/2132)) ([cc51faa](https://github.com/mbhall88/snakemake/commit/cc51faaa7d4f20896fc46b9fd67d062936d641bb))
* ensures that REncoder also checks for numpy.bool_ in encode_value ([#1749](https://github.com/mbhall88/snakemake/issues/1749)) ([10a6e1d](https://github.com/mbhall88/snakemake/commit/10a6e1de50ea7957e8685ba55b2cc115101cc23f))
* Escape workdir paths for potential spaces in paths ([#2196](https://github.com/mbhall88/snakemake/issues/2196)) ([9261f7e](https://github.com/mbhall88/snakemake/commit/9261f7ea50a8ae424c015faca73b7811fb51d093))
* fail with error if conda installation is not set to strict channel priorities ([#1672](https://github.com/mbhall88/snakemake/issues/1672)) ([f1ffbf2](https://github.com/mbhall88/snakemake/commit/f1ffbf28f04150c6e66297f242b768a22f80bd94))
* fix `--immediate-submit` ([#1851](https://github.com/mbhall88/snakemake/issues/1851)) ([e358372](https://github.com/mbhall88/snakemake/commit/e3583721f2dc620ce96876ecec58846d1cbe7bfd))
* fix cache handling and unlock handling ([2f4d5e1](https://github.com/mbhall88/snakemake/commit/2f4d5e11b36f199d3335839e9b5dc5d2094d11f8))
* Fix case of multiple scattergather processes ([#1799](https://github.com/mbhall88/snakemake/issues/1799)) ([417aad4](https://github.com/mbhall88/snakemake/commit/417aad4c1a5fe83bdf24729d0d4e70df112fd293))
* fix errors occurring when refering to input func via rules.&lt;rulename&gt;.input ([#1669](https://github.com/mbhall88/snakemake/issues/1669)) ([28a4795](https://github.com/mbhall88/snakemake/commit/28a47959bca2d135f82f9d8901b2b0aa228f30cb))
* fix false rerun triggering downstream of checkpoints due to spurious parameter, code or software env changes ([638ea86](https://github.com/mbhall88/snakemake/commit/638ea86c51ea5746c8b5452cc8a0e43108de15ef))
* fix false reruns after checkpoints ([#1907](https://github.com/mbhall88/snakemake/issues/1907)) ([dc5af12](https://github.com/mbhall88/snakemake/commit/dc5af12f54e774612bb1f8ead45e4597080dc100))
* fix falsely triggered reruns if input files are obtained via workflow.source_path() ([#1862](https://github.com/mbhall88/snakemake/issues/1862)) ([2dc2e6a](https://github.com/mbhall88/snakemake/commit/2dc2e6aa3255b8b73e06b7af1ea646d5081799ce))
* Fix handling of --jobs in no-exec state ([#2029](https://github.com/mbhall88/snakemake/issues/2029)) ([e8e8222](https://github.com/mbhall88/snakemake/commit/e8e8222a6f2192423aa55766304f9d1616a0d6e3))
* Fix inconsistencies between detailed summary and normal summary ([#2218](https://github.com/mbhall88/snakemake/issues/2218)) ([d903123](https://github.com/mbhall88/snakemake/commit/d9031236563b7dd8e31ed27208c9ad39699f765e))
* fix index out of bounds error raised by usage of workflow.source_path called from input or params functions (thanks @AKBrueggemann) ([#2170](https://github.com/mbhall88/snakemake/issues/2170)) ([cf8e6e8](https://github.com/mbhall88/snakemake/commit/cf8e6e8995ecb4371c179851f4ded1d01cd1b7f9))
* fix missed wildcard constraints when using local rule inheritance ([#2242](https://github.com/mbhall88/snakemake/issues/2242)) ([8e94785](https://github.com/mbhall88/snakemake/commit/8e947858dd510cb4c813f24093b5be843fa4cf6c))
* fix nargs definition for --deploy-sources ([fc252c8](https://github.com/mbhall88/snakemake/commit/fc252c80227e75a4fcf869f828d3c7d5d066f794))
* fix pandas import handling in metadata persistence ([27f7b40](https://github.com/mbhall88/snakemake/commit/27f7b4014eaea66aa4e599aa854dda75822d30a0))
* fix path handling when detective profiles ([fe63881](https://github.com/mbhall88/snakemake/commit/fe63881371036fc6d55e6a113cb3ed5029b31d2d))
* Fix race condition when creating lock directory ([#2225](https://github.com/mbhall88/snakemake/issues/2225)) ([66ea4d1](https://github.com/mbhall88/snakemake/commit/66ea4d199e3d9266b1b5fdb8752772e8137ffdea))
* fix regression in workflow source acquisition of google life science executor ([#1773](https://github.com/mbhall88/snakemake/issues/1773)) ([c07732e](https://github.com/mbhall88/snakemake/commit/c07732e2c7d6e95fabb3f2570bf0a1b0af2ac2cb))
* fix scrolling behavior in landing page of report for large workflows ([63c0c31](https://github.com/mbhall88/snakemake/commit/63c0c31c222a921a843d83e330a6f91e430f209a))
* fix storage handling on windows by converting all paths to posix paths ([#2519](https://github.com/mbhall88/snakemake/issues/2519)) ([7864a76](https://github.com/mbhall88/snakemake/commit/7864a76c41ad7839fb3b9aeb1c4468215ba0cb21))
* Fix technical bugs in resource-scope documentation ([#1784](https://github.com/mbhall88/snakemake/issues/1784)) ([878420c](https://github.com/mbhall88/snakemake/commit/878420c4496562df7fe5fed4e6f877e670dcd533))
* fix typo in line display of exceptions ([#1912](https://github.com/mbhall88/snakemake/issues/1912)) ([55e38a6](https://github.com/mbhall88/snakemake/commit/55e38a6f80c74b24d7763975b0ae2826d75f23d9))
* fixed bug in missing input file handling for cluster jobs ([#1544](https://github.com/mbhall88/snakemake/issues/1544)) ([40e2eb2](https://github.com/mbhall88/snakemake/commit/40e2eb2e6c6e31c7cc590c8d643e0640e9377aa4))
* fixed bug in needrun computation of jobs downsteam of checkpoints ([#1704](https://github.com/mbhall88/snakemake/issues/1704)) ([c634b78](https://github.com/mbhall88/snakemake/commit/c634b78b4d7c4f6ef59e46c94162893e42de6f73))
* fixed conda frontend detection and checking to also work with latest mambaforge ([#1781](https://github.com/mbhall88/snakemake/issues/1781)) ([225e68c](https://github.com/mbhall88/snakemake/commit/225e68cb05ecbf8fe001a884a416da0239cfd4d1))
* fixed detection of norun rules inside of modules ([#1566](https://github.com/mbhall88/snakemake/issues/1566)) ([d2223d4](https://github.com/mbhall88/snakemake/commit/d2223d41dfba057ab735395eac8339c27866c2ae))
* fixed handling of input functions and unpack when using the prefix setting of module definitions ([#1553](https://github.com/mbhall88/snakemake/issues/1553)) ([d561e04](https://github.com/mbhall88/snakemake/commit/d561e041a8919717046be0d39f197b2c6b937cb7))
* fixed parsing of subsequent use rule statements directly beneath each other ([#1548](https://github.com/mbhall88/snakemake/issues/1548)) ([77d5a08](https://github.com/mbhall88/snakemake/commit/77d5a08ab49d67b8cbd8ea4b6b6b7792edb38e3b))
* fixed permission issues when using zenodo remote provider to access restricted depositions ([#1634](https://github.com/mbhall88/snakemake/issues/1634)) ([510f534](https://github.com/mbhall88/snakemake/commit/510f534ff55635e5c3ca677e0ccd8c5b5dd7ca0f))
* fixed problem with leaked modifications when inheriting multiple times from the same rule ([#1957](https://github.com/mbhall88/snakemake/issues/1957)) ([2475cbc](https://github.com/mbhall88/snakemake/commit/2475cbcd74d9c9f62e07617751979bb00025850a))
* fixed typos ([#1847](https://github.com/mbhall88/snakemake/issues/1847)) ([a1e49b6](https://github.com/mbhall88/snakemake/commit/a1e49b6f290daeb2012575ab3a85ca72cfe42747))
* forwarding --keep-incomplete to cluster executor ([#1951](https://github.com/mbhall88/snakemake/issues/1951)) ([2894c7d](https://github.com/mbhall88/snakemake/commit/2894c7dfaa854ebe34b1248897c90b4110d3962b))
* ga4gh executor resources ([#2042](https://github.com/mbhall88/snakemake/issues/2042)) ([ad6eaef](https://github.com/mbhall88/snakemake/commit/ad6eaef6bac05d4de682f59d9d4a088f143b5798))
* get python version for script environment in a backwards compatible way that works down to python 2.7 ([#2161](https://github.com/mbhall88/snakemake/issues/2161)) ([44e59b9](https://github.com/mbhall88/snakemake/commit/44e59b9baa0842e19c5e0f2e05cf2fe5c9f47790))
* handle benmark bug that arise with singularity ([#1671](https://github.com/mbhall88/snakemake/issues/1671)) ([10ef7c4](https://github.com/mbhall88/snakemake/commit/10ef7c4d1cbbd89fa1760ec9f643e09ae4eb8bd9))
* handle case where zenodo deposition does not return files ([#2004](https://github.com/mbhall88/snakemake/issues/2004)) ([b63c4a7](https://github.com/mbhall88/snakemake/commit/b63c4a7e496ca7a3353e8a59b8ba493d65156cb5))
* handle different f-string tokens in py3.12 ([#2485](https://github.com/mbhall88/snakemake/issues/2485)) ([f2c7613](https://github.com/mbhall88/snakemake/commit/f2c761320a5a73d6027ae3649843e6bf6a24f324))
* handle non-PEP440 versions of apptainer/singulariy ([#2337](https://github.com/mbhall88/snakemake/issues/2337)) ([dea6ba8](https://github.com/mbhall88/snakemake/commit/dea6ba8808793b88c7553880bde48711abb037f8))
* Handle temp files for all jobs in a group. ([#1779](https://github.com/mbhall88/snakemake/issues/1779)) ([d28b893](https://github.com/mbhall88/snakemake/commit/d28b89363f007d303d733b2b12f517502867035c))
* handling of group jobs when obtaining temp input files ([71be1de](https://github.com/mbhall88/snakemake/commit/71be1de734032ae8c9e8b07fad57e36b321be421))
* handling of remaining jobs when using --keep-going ([#1693](https://github.com/mbhall88/snakemake/issues/1693)) ([87e4303](https://github.com/mbhall88/snakemake/commit/87e430354b45c702e4d782bad8461fde44477a48))
* import ([#2402](https://github.com/mbhall88/snakemake/issues/2402)) ([2c831f1](https://github.com/mbhall88/snakemake/commit/2c831f1fa98813cf5f69ecb046aad1364f514238))
* improved default resources parsing (also allowing to deactivate a default resource via setting it to None) ([#2006](https://github.com/mbhall88/snakemake/issues/2006)) ([e6cdb32](https://github.com/mbhall88/snakemake/commit/e6cdb32fd20a9899f441b3ec8aca3f36710f7a4a))
* improved provenance trigger info ([#1720](https://github.com/mbhall88/snakemake/issues/1720)) ([29d959d](https://github.com/mbhall88/snakemake/commit/29d959d86341aee66e945f216cae41e9c531a4d1))
* iRODS functionality - issue [#1510](https://github.com/mbhall88/snakemake/issues/1510) ([#1611](https://github.com/mbhall88/snakemake/issues/1611)) ([9c3767d](https://github.com/mbhall88/snakemake/commit/9c3767d6ee13a2c149a4ffe1c0547cabec0346dd))
* is_run error with local, group jobs ([#2133](https://github.com/mbhall88/snakemake/issues/2133)) ([31bfcd5](https://github.com/mbhall88/snakemake/commit/31bfcd5399540fc6cf52e3b76144e9abea6d4eab))
* issue [#1882](https://github.com/mbhall88/snakemake/issues/1882) WorkflowError: Metadata can't be created as it already exists (Windows) ([#1971](https://github.com/mbhall88/snakemake/issues/1971)) ([d4484e6](https://github.com/mbhall88/snakemake/commit/d4484e61ef49be23fc2bef8bf879185e521f5376))
* issue 1615 - Switch formatting condition for dictionary ([#1617](https://github.com/mbhall88/snakemake/issues/1617)) ([0771062](https://github.com/mbhall88/snakemake/commit/0771062a07f0e2cfe9ee45a2276aa61b096eb6e1))
* issue 1846 ([#1888](https://github.com/mbhall88/snakemake/issues/1888)) ([da2dfbd](https://github.com/mbhall88/snakemake/commit/da2dfbd765aa1e2a8da36d9eaa1ac9fcffa5e921))
* issue1460 intermediate files existing (or not) ([#1541](https://github.com/mbhall88/snakemake/issues/1541)) ([1b3ede1](https://github.com/mbhall88/snakemake/commit/1b3ede19159856a982de65e6293ab064c0987352))
* json validation error with markdown cells ([#1986](https://github.com/mbhall88/snakemake/issues/1986)) ([6c26f75](https://github.com/mbhall88/snakemake/commit/6c26f757785226d796c80689fabae771f316af9f))
* k8s container volume mounts as list ([#1868](https://github.com/mbhall88/snakemake/issues/1868)) ([5c54df3](https://github.com/mbhall88/snakemake/commit/5c54df39c6a111dcfa7adaea15d0b81a3fc16b90))
* lexicographically sorted rule display with --list, and trimmed rule docstrings ([#1880](https://github.com/mbhall88/snakemake/issues/1880)) ([32128ae](https://github.com/mbhall88/snakemake/commit/32128ae118d15f250e4b438735e30151cd6f27c5))
* limit filename length of temporary files generated by the persistence backend (metadata, incomplete markers, etc.) ([#1780](https://github.com/mbhall88/snakemake/issues/1780)) ([59053e7](https://github.com/mbhall88/snakemake/commit/59053e7017584ea94860cecb5ebecce66aed14ce))
* limit length of failed logs decorations ([#2125](https://github.com/mbhall88/snakemake/issues/2125)) ([6fc9243](https://github.com/mbhall88/snakemake/commit/6fc92434f5aaed60c3d1e62bf4d33c68eeb6ed53))
* make `--show-failed-logs` handle empty log files ([#2039](https://github.com/mbhall88/snakemake/issues/2039)) ([683c6f2](https://github.com/mbhall88/snakemake/commit/683c6f2284e867457d7ed25e838ed3018da8f2d4)), closes [#2023](https://github.com/mbhall88/snakemake/issues/2023)
* make python version check more robust ([#2058](https://github.com/mbhall88/snakemake/issues/2058)) ([e685621](https://github.com/mbhall88/snakemake/commit/e685621f3b4c0e21aa6f640dd571406d1d39e588))
* more comprehensive error reporting for RuleExceptions ([#1802](https://github.com/mbhall88/snakemake/issues/1802)) ([1cd9512](https://github.com/mbhall88/snakemake/commit/1cd95129a92e522e11689620473f68b1fe69fb42))
* more robust calculation of number of jobs until ready for execution ([#1691](https://github.com/mbhall88/snakemake/issues/1691)) ([fdfc717](https://github.com/mbhall88/snakemake/commit/fdfc717f8764ce535801d06805aaa1d59186ec84))
* more robust encoding of params in persistent metadata storage. This way, pandas parameters do not lead to spurious rerun triggers. ([#2080](https://github.com/mbhall88/snakemake/issues/2080)) ([106a4c3](https://github.com/mbhall88/snakemake/commit/106a4c3f4b181d787a6c309b8ea2e655780413e7))
* more robust parsing of sacct output in slurm executor ([#2036](https://github.com/mbhall88/snakemake/issues/2036)) ([fe651f8](https://github.com/mbhall88/snakemake/commit/fe651f8a10b9ead94b07ab31efe2d560525fc3b6))
* move max_status_checks_per_second attribute setting before the wait thread of cluster backends is started to avoid missing attribute errors ([#1775](https://github.com/mbhall88/snakemake/issues/1775)) ([a48e9d0](https://github.com/mbhall88/snakemake/commit/a48e9d035efec3a91b50bbda43ddf92196d5084b))
* Move quiet default after profile parsing ([#1764](https://github.com/mbhall88/snakemake/issues/1764)) ([6ade76d](https://github.com/mbhall88/snakemake/commit/6ade76d1287c8f62056853491a4e67b08a4739a6))
* multiext prefix computation in case it is used within a module that defines an additional prefix ([#1609](https://github.com/mbhall88/snakemake/issues/1609)) ([fc6dfc6](https://github.com/mbhall88/snakemake/commit/fc6dfc6469137a82382a36b9469190d967593759))
* None type error when invoking Workflow object manually ([#1731](https://github.com/mbhall88/snakemake/issues/1731)) ([dc45ccb](https://github.com/mbhall88/snakemake/commit/dc45ccb9ee94e8fcdf386c8598bbae57e319ba10))
* only consider global wildcard_constraints from the same module ([#2235](https://github.com/mbhall88/snakemake/issues/2235)) ([c412b71](https://github.com/mbhall88/snakemake/commit/c412b714a9fbe5cad9ad30de4a0b78b3c13068f6))
* only deactivate conda inject envs upon workflow tear down ([#2503](https://github.com/mbhall88/snakemake/issues/2503)) ([e6dfdd4](https://github.com/mbhall88/snakemake/commit/e6dfdd49cbaad228827f62a48cfe6419e4c1715e))
* only display a warning in case of non-strict channel priorities ([#1752](https://github.com/mbhall88/snakemake/issues/1752)) ([b84fa33](https://github.com/mbhall88/snakemake/commit/b84fa337f5c417360fc744202a419da3f37594b5))
* Open Snakefile for reading with explicit encoding specified ([#1146](https://github.com/mbhall88/snakemake/issues/1146)) ([ec1d859](https://github.com/mbhall88/snakemake/commit/ec1d859dd2422fa551bbf58843907fc5eed244ff))
* Panoptes --wms-monitor-arg ([#2444](https://github.com/mbhall88/snakemake/issues/2444)) ([98d2bdf](https://github.com/mbhall88/snakemake/commit/98d2bdfd1e3aeddf189b272d3e4042632248c10f))
* parsing error when combining single line directive with multi-line directive in use rule statements ([#1662](https://github.com/mbhall88/snakemake/issues/1662)) ([26e57d6](https://github.com/mbhall88/snakemake/commit/26e57d69fc320adc972967a8046c5163b455456c))
* parsing error when last line is comment ([#2054](https://github.com/mbhall88/snakemake/issues/2054)) ([a928dd4](https://github.com/mbhall88/snakemake/commit/a928dd4391d186b6ddb582331047f09fbee03f03))
* pass triggers and resources to subworkflow ([#1733](https://github.com/mbhall88/snakemake/issues/1733)) ([fa7fb75](https://github.com/mbhall88/snakemake/commit/fa7fb75d2314cd2965a9f578506e27aae4b07349))
* Postprocess job groups in toposorted order for correct touch times ([#2073](https://github.com/mbhall88/snakemake/issues/2073)) ([10b5849](https://github.com/mbhall88/snakemake/commit/10b584916a869fa1147a9f42d1de4fec4120b441))
* preserve dtypes across paramspace ([#1578](https://github.com/mbhall88/snakemake/issues/1578)) ([70ce6a0](https://github.com/mbhall88/snakemake/commit/70ce6a0feb8572ddcf888c3d377d631ea4a24370))
* prevent overriding of retries when set to 0 ([#2053](https://github.com/mbhall88/snakemake/issues/2053)) ([a328f3e](https://github.com/mbhall88/snakemake/commit/a328f3e009a53002781539dfe3e3c8c5d1738189))
* prevents DeprecationWarning caused by using old  draft of json schema ([#2152](https://github.com/mbhall88/snakemake/issues/2152)) ([9791ffb](https://github.com/mbhall88/snakemake/commit/9791ffb978a6d09d90d311cc98363c4d4efc2042))
* print exceptions when job is not a shell job ([#2385](https://github.com/mbhall88/snakemake/issues/2385)) ([8a37b85](https://github.com/mbhall88/snakemake/commit/8a37b8584f216ada10caffcbb8b731efd675376a))
* propagate attempt count from group to subjobs ([#2052](https://github.com/mbhall88/snakemake/issues/2052)) ([da3f1c0](https://github.com/mbhall88/snakemake/commit/da3f1c0a80ffabbe9d02ce1361bfa2374c546007))
* propagate rerun trigger info to cluster jobs; fix a bug leading to software stack trigger generating false positives in case of conda environments; fixed display of info message in case of provenance triggered reruns ([#1686](https://github.com/mbhall88/snakemake/issues/1686)) ([503c70c](https://github.com/mbhall88/snakemake/commit/503c70c7727e154f8fadf6ead088887d22a87a65))
* proper error message if resource types do not match ([#1556](https://github.com/mbhall88/snakemake/issues/1556)) ([1112321](https://github.com/mbhall88/snakemake/commit/11123213188672a3b6e5acfffed18d9e0ccc8819))
* proper reuse of rule proxies when importing several times from the same module ([#2404](https://github.com/mbhall88/snakemake/issues/2404)) ([e867dda](https://github.com/mbhall88/snakemake/commit/e867dda24dff306f42939ad0d4d93d32ec94f6e5))
* properly handle NA values for paramspaces ([#2098](https://github.com/mbhall88/snakemake/issues/2098)) ([6b6a880](https://github.com/mbhall88/snakemake/commit/6b6a88074eac6e3a9aa8c89501fc9481f07ecc1d))
* properly use configfiles specified via CLI also if configfile specified via configfile directive is not present ([1e0649a](https://github.com/mbhall88/snakemake/commit/1e0649ac37176a68bb2d8f4d1508ac8bb02463ff))
* properly use retry mechanism in source cache ([#1564](https://github.com/mbhall88/snakemake/issues/1564)) ([624a83d](https://github.com/mbhall88/snakemake/commit/624a83d1bfc592a2a1878d5191e09f6c3d7ee7c2))
* quote paths given to singularity in order to ensure that it does not fail when paths contain whitespace ([#2190](https://github.com/mbhall88/snakemake/issues/2190)) ([a572fb7](https://github.com/mbhall88/snakemake/commit/a572fb7b8f00e39723cd98d6936f63171b26c8d9))
* quote workdir in job exec prefix to allow to spaces in the workdir ([#1547](https://github.com/mbhall88/snakemake/issues/1547)) ([c3a593e](https://github.com/mbhall88/snakemake/commit/c3a593e8f7fc8e0dccec4e025f4cd9743bd80bc3))
* raise error if callable is passed to expand. ([#2171](https://github.com/mbhall88/snakemake/issues/2171)) ([1f28476](https://github.com/mbhall88/snakemake/commit/1f28476c35dc15a04e1032139b9dab5779801235))
* reduce resource requirements for kubernetes tests ([#1876](https://github.com/mbhall88/snakemake/issues/1876)) ([cb4b78a](https://github.com/mbhall88/snakemake/commit/cb4b78a05ee08f7dafb561ba33bbe460ec097eb5))
* regression ValueError introduced with 7.17.2 ([#1947](https://github.com/mbhall88/snakemake/issues/1947)) ([53a4fca](https://github.com/mbhall88/snakemake/commit/53a4fca8c67a3b58d61b146c8cfff3982889d77d))
* remote GS builds too many inventories; io:collect_mtime always uses uncached mtime ([#2266](https://github.com/mbhall88/snakemake/issues/2266)) ([bad9115](https://github.com/mbhall88/snakemake/commit/bad91152eeb70693e1459324f738a8c481378801))
* remote-azblob-sasToken-Authorization ([#1800](https://github.com/mbhall88/snakemake/issues/1800)) ([bc854a7](https://github.com/mbhall88/snakemake/commit/bc854a7e012cac751b708df83378fd5791e6e6fc))
* remove overflow from rulegraph div in report ([9a0aaa7](https://github.com/mbhall88/snakemake/commit/9a0aaa703d6531d890b7116638dc515425f6ed34))
* remove redundant dot in expand call in multiext documentation ([#1921](https://github.com/mbhall88/snakemake/issues/1921)) ([278beaa](https://github.com/mbhall88/snakemake/commit/278beaa7c81b9e418fa42ac5f944e3d7e2cdfbbd))
* remove redundant print ([#1608](https://github.com/mbhall88/snakemake/issues/1608)) ([cc7e0e3](https://github.com/mbhall88/snakemake/commit/cc7e0e3605bd65ffcb2d055e69761ff7337588ae))
* remove superfluous comma causing TypeError in conda-frontend error message ([#1804](https://github.com/mbhall88/snakemake/issues/1804)) ([87b013c](https://github.com/mbhall88/snakemake/commit/87b013cbba420b71892ab9f482718c1cd59e6bda))
* remove superfluous dependency ([aad61a0](https://github.com/mbhall88/snakemake/commit/aad61a0131d7ca0f7393af23b98b1db702cd976d))
* removed distutils from snakemake ([#2312](https://github.com/mbhall88/snakemake/issues/2312)) ([9b8c362](https://github.com/mbhall88/snakemake/commit/9b8c3620e8c14e322ba15b7d044b9deab1854b2a))
* report error and possible cause if metadata cleanup fails ([#1554](https://github.com/mbhall88/snakemake/issues/1554)) ([6866134](https://github.com/mbhall88/snakemake/commit/68661341efa0a3de4e03de3fb1b8f3117de66efe))
* report spacing ([f3954b3](https://github.com/mbhall88/snakemake/commit/f3954b33536314e6a252c044eee5f424dd234065))
* request disk_mb resource from k8s ([#1858](https://github.com/mbhall88/snakemake/issues/1858)) ([f68f166](https://github.com/mbhall88/snakemake/commit/f68f166582abaeb45a1a093306626bb8abb0e0bb))
* require python &gt;=3.7 again (the python 3.9 dependency was unnecessary) ([#2372](https://github.com/mbhall88/snakemake/issues/2372)) ([0d0e9c4](https://github.com/mbhall88/snakemake/commit/0d0e9c4cf48a97952464e6da476ed7661d629ce3))
* require toposort &gt;= 1.10 ([#2145](https://github.com/mbhall88/snakemake/issues/2145)) ([3cb54b8](https://github.com/mbhall88/snakemake/commit/3cb54b8c62743897f20feb3fcf269a7357878434))
* respect shebang lines in post-deploy scripts (see deployment docs) ([#1841](https://github.com/mbhall88/snakemake/issues/1841)) ([c26c4b6](https://github.com/mbhall88/snakemake/commit/c26c4b6ff43e38797168ef7983c40b0c8a4b2f8c))
* Restore backward compatibility for Google Life Sciences executor ([#2461](https://github.com/mbhall88/snakemake/issues/2461)) ([5e3a464](https://github.com/mbhall88/snakemake/commit/5e3a46476d78d5d52340a9ffa327d18a5e7e9828))
* rounding for batch calculation ([#2064](https://github.com/mbhall88/snakemake/issues/2064)) ([cbdbf9b](https://github.com/mbhall88/snakemake/commit/cbdbf9b648124422ffe16c61b776f92c33c72ef8))
* set channel priority in container system wide ([#1690](https://github.com/mbhall88/snakemake/issues/1690)) ([41175b3](https://github.com/mbhall88/snakemake/commit/41175b3001ff59db5d7ea8bf91354decea04f74d))
* shadow "full" mode ignore symlinks ([#2516](https://github.com/mbhall88/snakemake/issues/2516)) ([1d58120](https://github.com/mbhall88/snakemake/commit/1d5812027e5d1a8d5f2e45175fa38d28ca32763e))
* show failed logs in executor testcases ([92f7bf4](https://github.com/mbhall88/snakemake/commit/92f7bf4b86f491073898b2385c3ed45a557a3b4d))
* show input files on job error ([#1949](https://github.com/mbhall88/snakemake/issues/1949)) ([ad21631](https://github.com/mbhall88/snakemake/commit/ad2163187f031317d889e0cbe368176e1d48d13f))
* skip type checks of missing dir in touch mode ([#2051](https://github.com/mbhall88/snakemake/issues/2051)) ([ae00c25](https://github.com/mbhall88/snakemake/commit/ae00c25541600dba14ad68f1145bab3c4455de19))
* slurm batch job status queries ([#2167](https://github.com/mbhall88/snakemake/issues/2167)) ([0bb69e4](https://github.com/mbhall88/snakemake/commit/0bb69e429e161bf68b1f3e0b8f6fe3cbd6ed4dae))
* slurm default_resources quoting ([#2043](https://github.com/mbhall88/snakemake/issues/2043)) ([47d3fc3](https://github.com/mbhall88/snakemake/commit/47d3fc3eef8ebe54df8b77f100fc2ab3fa36c190))
* small changes to make docs checkpoint example functional ([#1714](https://github.com/mbhall88/snakemake/issues/1714)) ([1d4909e](https://github.com/mbhall88/snakemake/commit/1d4909ef838ac79f8e7be9f29d76b969d358ef1b))
* Solve apptainer version issue ([#2333](https://github.com/mbhall88/snakemake/issues/2333)) ([a876e0f](https://github.com/mbhall88/snakemake/commit/a876e0f5e187168eb269b504918c6aeff1496f16))
* sort report (sub-)categories in lexicographical order ([#2449](https://github.com/mbhall88/snakemake/issues/2449)) ([d0705ad](https://github.com/mbhall88/snakemake/commit/d0705adb4702ead9db0c26809859c7b769d800e1))
* support multiple input files for template_engine rules ([#1571](https://github.com/mbhall88/snakemake/issues/1571)) ([aee7cf2](https://github.com/mbhall88/snakemake/commit/aee7cf236611e5201feda152f5b7357b49b9f15b))
* SyntaxWarnings due to non-raw regex pattern strings ([#2359](https://github.com/mbhall88/snakemake/issues/2359)) ([a08c0b0](https://github.com/mbhall88/snakemake/commit/a08c0b071b2f9a9212117bbcf560fa67f1a02178))
* unnecessary set Snakefile in AzBatch executor ([#2397](https://github.com/mbhall88/snakemake/issues/2397)) ([78e6d6e](https://github.com/mbhall88/snakemake/commit/78e6d6ec6a1ad930e40d6edfe9f7210232a674f2))
* Update __init__.py to move "file" param to "print" ([#2291](https://github.com/mbhall88/snakemake/issues/2291)) ([92352b6](https://github.com/mbhall88/snakemake/commit/92352b69d14ef196b0253561c78fa04ffa25d73e))
* Update list of python versions in classifiers ([#2020](https://github.com/mbhall88/snakemake/issues/2020)) ([7a98100](https://github.com/mbhall88/snakemake/commit/7a98100ba92b0174c8ead3ae715042c1ab710c61))
* update minimum snakemake-interface-storage-plugins version ([0ef7226](https://github.com/mbhall88/snakemake/commit/0ef72262e29a5b22cdf016a4ab6aba4b8dbc686d))
* updating of non-dict config values gives error ([#2364](https://github.com/mbhall88/snakemake/issues/2364)) ([b33aeec](https://github.com/mbhall88/snakemake/commit/b33aeecdf51afba6012007a2b125b9c87b7b98f2))
* Use `job.rule.name` attribute to fill rule field in summary ([#2217](https://github.com/mbhall88/snakemake/issues/2217)) ([837c3fd](https://github.com/mbhall88/snakemake/commit/837c3fd97b5a16ddb4f6b74bd2c2b5479d77bd8a))
* use mambaforge for snakemake container image ([#1595](https://github.com/mbhall88/snakemake/issues/1595)) ([b7e6906](https://github.com/mbhall88/snakemake/commit/b7e6906926cae5fef6987adcf7b0294266d5faec))
* use short argument name for `--chdir` for compatibility with Slurm &lt;=v17 ([#2040](https://github.com/mbhall88/snakemake/issues/2040)) ([a9ed3ec](https://github.com/mbhall88/snakemake/commit/a9ed3ec3e823442810388fce8a17ba4950bbdaa2))
* use temporary directory (faster, more likely local, always writable) for persistence and source cache in case of remote execution without shared fs ([#2502](https://github.com/mbhall88/snakemake/issues/2502)) ([c8fa7ba](https://github.com/mbhall88/snakemake/commit/c8fa7ba3ee70c9c62011a3839758a5eb8fde16f8))
* use text/markdown for long_description_content_type ([#2112](https://github.com/mbhall88/snakemake/issues/2112)) ([0241075](https://github.com/mbhall88/snakemake/commit/02410755c51df21833199db70406b2179248380e))
* wait for logs before showing them on error ([a4ff328](https://github.com/mbhall88/snakemake/commit/a4ff3280db0beb4f1a077ee880433f767c4ad142))
* wms-monitor now gets data in correct json format ([#2347](https://github.com/mbhall88/snakemake/issues/2347)) ([7fafa7a](https://github.com/mbhall88/snakemake/commit/7fafa7ace72f8a727457f4abe6db2f9ed2d74d64))
* wrong rule names when nesting module imports ([#1817](https://github.com/mbhall88/snakemake/issues/1817)) ([65c79a4](https://github.com/mbhall88/snakemake/commit/65c79a48f956077839bb5ab1ea8d60a5f0ddecab))


### Performance Improvements

* Average NamedList __getitem__ performance improvement ([#1825](https://github.com/mbhall88/snakemake/issues/1825)) ([10451b7](https://github.com/mbhall88/snakemake/commit/10451b7198a4a39149ce5e8ec82c17df1f18813b))
* avoid superflous mtime checks when the same file is referred to by multiple jobs ([#2284](https://github.com/mbhall88/snakemake/issues/2284)) ([eb6e2e1](https://github.com/mbhall88/snakemake/commit/eb6e2e161f01c61b139d95bcf1ddfa862f8029ba))
* cached os.pathconf() call in _record_path() ([#1920](https://github.com/mbhall88/snakemake/issues/1920)) ([551badb](https://github.com/mbhall88/snakemake/commit/551badb4eb9de582278185449d8fa9298ad7ae8c))
* Gfal2 remote provider using gfal2-python instead of  gfal2-utils. ([#2128](https://github.com/mbhall88/snakemake/issues/2128)) ([0b9bfe5](https://github.com/mbhall88/snakemake/commit/0b9bfe500a06e669d2557d897ed26550aec526d6))
* Improve execution speed of cleanup_workdir (in dag)  ([#2103](https://github.com/mbhall88/snakemake/issues/2103)) ([1fbc5f5](https://github.com/mbhall88/snakemake/commit/1fbc5f5aee65bc8dd776765644d07051dd857670))


### Documentation

* add workflows.community metadata ([#1736](https://github.com/mbhall88/snakemake/issues/1736)) ([8a42afc](https://github.com/mbhall88/snakemake/commit/8a42afc053e3f398f1a299fb3234ca0ee847faae))
* added changelog info for &gt;v7.19.1 parsing error of "hh:mm:ss" time format in runtime resource ([#2189](https://github.com/mbhall88/snakemake/issues/2189)) ([2889f38](https://github.com/mbhall88/snakemake/commit/2889f3851b64cee7885fbf73f64a453eed5e806a))
* basics.rst: suggest VS Code instead of deprecated Atom as IDE ([#2368](https://github.com/mbhall88/snakemake/issues/2368)) ([1357316](https://github.com/mbhall88/snakemake/commit/135731605b974915cd2bd78b88a981f974bc7b78))
* Change snakemake-tutorial download link to always be the latest ([#2183](https://github.com/mbhall88/snakemake/issues/2183)) ([ae8a8f4](https://github.com/mbhall88/snakemake/commit/ae8a8f4abca233e0c162e3fbd9dfb29ef38f98e6))
* checkpoint documentation ([#1562](https://github.com/mbhall88/snakemake/issues/1562)) ([4cbfb47](https://github.com/mbhall88/snakemake/commit/4cbfb4786a729a0c899a0a3e0427c1c1f0796c15))
* clarify minimum Snakemake version for profiles ([86dc277](https://github.com/mbhall88/snakemake/commit/86dc277d530a557c9bdd6784b863f63ab859a1c7))
* clarify the channel priority in environment definition deployment.rst ([#2352](https://github.com/mbhall88/snakemake/issues/2352)) ([76aa964](https://github.com/mbhall88/snakemake/commit/76aa964c38b4aa069d9cce6f8f43c91c7d496cfb))
* document name directive with example ([cd49c34](https://github.com/mbhall88/snakemake/commit/cd49c34841e392611634b57f01e77fb0f46f2a5a))
* explain SNAKEMAKE_PROFILE environment variable ([2b32bba](https://github.com/mbhall88/snakemake/commit/2b32bba6efa53a9359bc67d8eb8ce06f1106e8ef))
* fix a copy&paste (?) mistake ([#2386](https://github.com/mbhall88/snakemake/issues/2386)) ([d878847](https://github.com/mbhall88/snakemake/commit/d87884749fd9450062f6fde5b7727867396e7a78))
* fix formatting ([087fe63](https://github.com/mbhall88/snakemake/commit/087fe6307a72a577daefcea0cb150f69092138c7))
* fix grammar in the intro ([#1859](https://github.com/mbhall88/snakemake/issues/1859)) ([774bc6a](https://github.com/mbhall88/snakemake/commit/774bc6aaa3105c94a551691498d9a5efb13ac216))
* fix link ([4889c93](https://github.com/mbhall88/snakemake/commit/4889c93a031acc3ada22c9bdfd27301cce2c107e))
* fix long description type for pypi (set to markdown) ([d8d9b8f](https://github.com/mbhall88/snakemake/commit/d8d9b8f284d2863f672cd96fd96d2034806d52de))
* fix minor typos in a linting rule ([#2162](https://github.com/mbhall88/snakemake/issues/2162)) ([71e1171](https://github.com/mbhall88/snakemake/commit/71e1171a0dab824baed77bfe235268af9e095c1f))
* fix small type in FAQ ([#1832](https://github.com/mbhall88/snakemake/issues/1832)) ([914172b](https://github.com/mbhall88/snakemake/commit/914172baf366570fa2a2818746d3ed1417790e3a))
* fix statement about logging ([#2252](https://github.com/mbhall88/snakemake/issues/2252)) ([56c24b6](https://github.com/mbhall88/snakemake/commit/56c24b6436cee9a4962d006bb201708c7a37c474))
* fix syntax in cluster example ([#2460](https://github.com/mbhall88/snakemake/issues/2460)) ([64e9645](https://github.com/mbhall88/snakemake/commit/64e964554748bdee93bad1c7e6cd2924595c414f))
* fix typo ([e1c3cc6](https://github.com/mbhall88/snakemake/commit/e1c3cc6c6ddbf67e9d3cfc9dcef9bcf35b0060f3))
* fix typo ([#1843](https://github.com/mbhall88/snakemake/issues/1843)) ([6572ad9](https://github.com/mbhall88/snakemake/commit/6572ad91bed14dece6b01a26134007a25ef0c4b2))
* fix typo (stackoverflow issue) ([#2365](https://github.com/mbhall88/snakemake/issues/2365)) ([f770984](https://github.com/mbhall88/snakemake/commit/f7709844cd932465859a2095edafcf9baa8c2bf7))
* Fix typo in SLURM help text ([#2049](https://github.com/mbhall88/snakemake/issues/2049)) ([79b7025](https://github.com/mbhall88/snakemake/commit/79b702528b9801d0283766f2da377d4b9daeebd2))
* fix typos ([e45b9e6](https://github.com/mbhall88/snakemake/commit/e45b9e608c31af5a5c3389520486d46935549eb4))
* fix typos ([151095d](https://github.com/mbhall88/snakemake/commit/151095ddc839860d33a27cafeb83260dc17d736b))
* fix typos in --help ([#2182](https://github.com/mbhall88/snakemake/issues/2182)) ([09f0cbe](https://github.com/mbhall88/snakemake/commit/09f0cbe9452a22bde768c7049eeb17f1c93db7ea))
* format table ([4180a1b](https://github.com/mbhall88/snakemake/commit/4180a1b6a8b7104e27a748c638275b98c5998200))
* Improve error message when rule contains multiple run/shell/script/notebook/wrapper/template_engine/cwl keywords ([#2186](https://github.com/mbhall88/snakemake/issues/2186)) ([cd5a3c4](https://github.com/mbhall88/snakemake/commit/cd5a3c44eace393f24d9338b21d5ef3cb6298126))
* mention XDG_CACHE_HOME ([#2057](https://github.com/mbhall88/snakemake/issues/2057)) ([ec2ef45](https://github.com/mbhall88/snakemake/commit/ec2ef45c5e49f97a0b58535f8e39152d2789d428))
* note on using checkpoint mechanism only for input function, not for params or resources. ([#2353](https://github.com/mbhall88/snakemake/issues/2353)) ([4be2f9d](https://github.com/mbhall88/snakemake/commit/4be2f9dd9fb41dc169bae068753ceed9552248e7))
* notes on arm based machines in tutorial docs ([0586f04](https://github.com/mbhall88/snakemake/commit/0586f04d2b03443a25deddd017f303156acdcd9c))
* polished text and table display ([413356c](https://github.com/mbhall88/snakemake/commit/413356cceb8d3a96b24531ef350168e681c9d383))
* replace `nosetest` with `pytest` ([#2211](https://github.com/mbhall88/snakemake/issues/2211)) ([f6b3c47](https://github.com/mbhall88/snakemake/commit/f6b3c47983bfe436f8ec33ab5830ba577fc38f90))
* **rust:** Fix typo on rust-script version ([#2488](https://github.com/mbhall88/snakemake/issues/2488)) ([a79dd94](https://github.com/mbhall88/snakemake/commit/a79dd94f330f1d5c1fba7d16cb5b08bd780d950d))
* singularity sometimes uses system /tmp explanation ([#1588](https://github.com/mbhall88/snakemake/issues/1588)) ([170c1d9](https://github.com/mbhall88/snakemake/commit/170c1d9d92de4cafc0da9567a6970b173161c7da))
* small tweaks to flux documentation ([#1886](https://github.com/mbhall88/snakemake/issues/1886)) ([f29b371](https://github.com/mbhall88/snakemake/commit/f29b37106727c470b691076189e92f35e4cecfb6))
* update CHANGELOG.md: add minimum Python version bump ([#2370](https://github.com/mbhall88/snakemake/issues/2370)) ([48e934d](https://github.com/mbhall88/snakemake/commit/48e934dcf96e4e8fd30c81cab3674583bf049a45))
* update contribution docs ([09a5595](https://github.com/mbhall88/snakemake/commit/09a559504d7a4346e40d8b3a99ece46e903ff7a0))
* update docs for azbatch and dockerhub ref ([#2298](https://github.com/mbhall88/snakemake/issues/2298)) ([908dbf1](https://github.com/mbhall88/snakemake/commit/908dbf143d4b1625fa6ee80f2b4eb713a6411a3f))
* update misc/vim/Readme with info for packer.nvim ([#2095](https://github.com/mbhall88/snakemake/issues/2095)) ([32166a7](https://github.com/mbhall88/snakemake/commit/32166a7fce95312bfa6b6d3ae76bf94accf6d5de))
* Update modularization.rst ([#2137](https://github.com/mbhall88/snakemake/issues/2137)) ([16954c7](https://github.com/mbhall88/snakemake/commit/16954c7b633049df6646275139251097d574fd35))
* Update workflow syntax with priority directive ([#2188](https://github.com/mbhall88/snakemake/issues/2188)) ([af10db5](https://github.com/mbhall88/snakemake/commit/af10db56b11badfab2aa4f3aa9fa4bbe3c05fe7d))
* various little fixes ([#1875](https://github.com/mbhall88/snakemake/issues/1875)) ([b93f8e3](https://github.com/mbhall88/snakemake/commit/b93f8e316cb2f51e72933e7a28872bdf523aec11))
